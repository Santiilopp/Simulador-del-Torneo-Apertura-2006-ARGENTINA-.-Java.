...
public class Partido {
	...
	/**
	 * pre: Club correctamente inicializado. 
	 * post: Se generaran ,de forma aleatoria,
	 ...
	 * En caso de que sea gol, se definira si el gol lo anoto un jugador del plantel,
	 * o si simplemete fue anotado por algun jugador del equipo.
	 * 
